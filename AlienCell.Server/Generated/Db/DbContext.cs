...
public partial class DbContext
{
    ...
    private void InitDb()
    {
        ...
        Connection.Execute("CREATE TABLE IF NOT EXISTS `artifact_models` (`Id` varbinary(16) not null, `UserId` varbinary(16) not null, `Exp` bigint not null, `Level` cs_int not null, `Data` int not null, PRIMARY KEY (`Id`));");
        ...
        Connection.Execute("CREATE TABLE IF NOT EXISTS `hero_models` (`Id` varbinary(16) not null, `UserId` varbinary(16) not null, `Exp` bigint not null, `Level` cs_int not null, `Data` int not null, PRIMARY KEY (`Id`));");
        Connection.Execute("CREATE TABLE IF NOT EXISTS `weapon_models` (`Id` varbinary(16) not null, `UserId` varbinary(16) not null, `Exp` bigint not null, `Level` cs_int not null, `Data` int not null, PRIMARY KEY (`Id`));");
    }
